...
class LineItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create line_item via turbo-stream" do
    ...
    assert_response :success
    assert_match /<tr class="line-item-highlight-add">/, @response.body
  end

  test "should create line_item for duplicate product" do
    assert_difference("LineItem.count") do
      post line_items_url, params: { product_id: products(:pragprog).id }
    end
  ...
  test "should destroy line_item" do
    ...
    # assert_redirected_to line_items_url # would include if wasn't using turbo; no need to redirect
  end
end
